...
const mempoolPkg = readJson("tsn-protocol/services/tsn-mempool-ui/package.json");
...
console.log(`TSN Mempool UI files: ${countFiles("tsn-protocol/services/tsn-mempool-ui")}`);
