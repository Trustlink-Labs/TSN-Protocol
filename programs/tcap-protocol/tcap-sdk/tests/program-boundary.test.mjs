...
const legacyLib = readFileSync(
  new URL("../../../tsn/protocol/programs/trustlink-escrow/src/lib.rs", import.meta.url),
  "utf8",
);
const legacyVault = readFileSync(
  new URL("../../../tsn/protocol/programs/trustlink-escrow/src/tsn/state/vault.rs", import.meta.url),
  "utf8",
);
