...
export const VERIFIED_PROVIDER_EXECUTION_ENABLED_FLAG =
  "VERIFIED_PROVIDER_EXECUTION_ENABLED";

export const TSN_GLOBAL_CONFIG_RECURRING_MANDATES_FLAG =
  "recurring_mandates_enabled";
export const TSN_GLOBAL_CONFIG_VERIFIED_PROVIDER_EXECUTION_FLAG =
  "verified_provider_execution_enabled";
...
export function recurringFeatureFlagsFromEnv(
  ...
  return {
    ...
    verifiedProviderExecutionEnabled:
      env[VERIFIED_PROVIDER_EXECUTION_ENABLED_FLAG] === "true",
  };
}
