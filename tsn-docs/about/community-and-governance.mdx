...
description: "How the TSN community proposes, reviews, and votes on settlement routes without replacing the cryptographic authorization that gates every payment."
---
