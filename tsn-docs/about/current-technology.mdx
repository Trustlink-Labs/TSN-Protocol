...
description: "What runs on Solana Devnet today: TSN intents, TIN registry, GPRU routing, Mother Escrow, Node verification, Cranker submission, and TCAP credits."
---
