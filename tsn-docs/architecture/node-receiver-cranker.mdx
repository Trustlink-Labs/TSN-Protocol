...
description: "How TSN splits Receiver ingress, Mother Node verification, and Cranker submission into non-overlapping roles that never share secrets or alter signed plans."
---
