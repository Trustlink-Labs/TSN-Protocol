...
description: "How TSN splits durable ingress (Receiver), stateless verification (Node), and exact transaction submission (Cranker) without sharing secrets or altering plans."
---
