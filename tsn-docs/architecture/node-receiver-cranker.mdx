...
description: "How TSN splits ingress, verification, and submission across the Receiver, Mother Node, and Cranker Node, and the boundary each role cannot cross."
---
