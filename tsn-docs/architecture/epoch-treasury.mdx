...
description: "How the TSN Epoch Treasury records aggregate funding and settlement liability with opaque slots, and why it is protocol accounting rather than a user balance."
---
