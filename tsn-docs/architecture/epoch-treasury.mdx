...
description: "How the Epoch Treasury records aggregate funding and settlement liability through opaque slots as protocol-controlled accounting, not a user balance."
---
