...
description: "How the TSN Epoch Treasury tracks aggregate funding and liability, uses opaque EpochClaimSlot PDAs, and gates epoch close on zero pending liability."
---
...
| Open epoch | Settlement | Slot marked `SETTLED`; liability decremented; CrankerVault reimbursed atomically from the epoch treasury for the exact amount |
