...
description: "Every key in TSN: sender wallet, TIN owner commitment, Node permit, Mother authority, encrypted binding, and owner snapshot, with scope and rotation model."
---
