...
description: "Every TSN key and credential with its owner, authorization scope, and rotation model: sender wallet, TIN commitment, Node permit, Mother, and snapshot key."
---
