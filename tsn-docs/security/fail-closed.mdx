...
description: "How TSN fails closed: ordered checks from Receiver ingress through Node verification, Cranker lease, and Solana program enforcement reject before tokens move."
---
