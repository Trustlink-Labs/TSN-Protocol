...
description: "TSN fails closed: any failed check rejects the operation with no partial settlement. Walk the ordered checks from Receiver ingress through on-chain enforcement."
---
