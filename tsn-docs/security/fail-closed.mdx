...
description: "TSN fails closed: any failed check rejects with no partial settlement. The ordered checks from Receiver ingress through Solana program enforcement."
---
