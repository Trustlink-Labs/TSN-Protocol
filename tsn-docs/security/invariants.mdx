...
description: "The protocol invariants TSN and TCAP enforce on Solana: signed field binding, single-consume slots and nullifiers, sequence monotonicity, and binding."
---
