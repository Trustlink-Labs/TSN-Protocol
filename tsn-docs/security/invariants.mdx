...
description: "The protocol invariants TSN and TCAP enforce on Solana: signed field binding, single-consume slots and nullifiers, monotonic sequence, and commitment binding."
---
