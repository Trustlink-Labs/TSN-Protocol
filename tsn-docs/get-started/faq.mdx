...
No. Every payout is authorized by a specific Mother-rooted DNA permit. The Node/Mother holds the encrypted payment binding. The parties holding the settlement DNA and the encrypted binding can audit payments.
