...
TODO: confirm the current resolver transport and returned identity fields from `tins.ts:1618-2097`; this page does not expose a guessed HTTP endpoint for a library-only function.

Source: [`index.ts`](https://github.com/Trustlink-Labs/TSN-Protocol/blob/main/tsn-protocol/sdks/tsn-sdk/src/index.ts), [`network-status.ts`](https://github.com/Trustlink-Labs/TSN-Protocol/blob/main/tsn-protocol/sdks/tsn-sdk/src/network-status.ts), [`payment-authorization.ts`](https://github.com/Trustlink-Labs/TSN-Protocol/blob/main/tsn-protocol/sdks/tsn-sdk/src/payment-authorization.ts), [`tins.ts:1115-2097`](https://github.com/Trustlink-Labs/TSN-Protocol/blob/main/tsn-protocol/sdks/tsn-sdk/src/tins.ts#L1115-L2097), [`cross-chain.ts`](https://github.com/Trustlink-Labs/TSN-Protocol/blob/main/tsn-protocol/sdks/tsn-sdk/src/cross-chain.ts)
