...
description: "Install the TSN SDK, resolve a TIN, sign a payment intent, and submit it through the TSN Receiver on Devnet to follow the full work lifecycle to confirmation."
---
