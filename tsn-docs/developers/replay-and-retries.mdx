...
description: "How TSN prevents double spending with replay nonces, nullifiers, slot windows, and sequence monotonicity, plus safe retry patterns for settlement failures."
---
