...
This page explains the funding and acceptance phase of a TSN payment. You will learn how the SDK builds a treasury funding transaction and how the Node verifies it. You will also learn how the Mother authority materializes settlement state and how the AcceptedIntent PDA checks every bound field before TCAP credit advances.
